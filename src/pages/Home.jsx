        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-8">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600 font-semibold tracking-wider uppercase text-sm">
                Meet UKTI
              </span>
              <h2 className="text-4xl lg:text-5xl font-bold text-white mt-3 mb-4">AI for Early Learning in Schools</h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
                UKTI is an AI-powered early learning platform that helps schools deliver engaging, activity-based learning for young children. It combines voice, image recognition, and guided classroom workflows.
              </p>
            </motion.div>

            {/* Hero-style showcase container */}
            <motion.div variants={fadeInUp} className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
              <div className="bg-gray-900/60 border border-gray-700 rounded-2xl p-6 md:p-8">
                <h3 className="text-2xl font-bold text-white mb-4">Why UKTI</h3>
                <div className="space-y-3 text-gray-200">
                  <div className="bg-gray-800/60 border border-gray-700 rounded-lg px-4 py-3">AI-assisted learning through voice + visual interaction</div>
                  <div className="bg-gray-800/60 border border-gray-700 rounded-lg px-4 py-3">Built for schools, teachers, and classroom workflows</div>
                  <div className="bg-gray-800/60 border border-gray-700 rounded-lg px-4 py-3">Real-time student activity tracking and progress visibility</div>
                  <div className="bg-gray-800/60 border border-gray-700 rounded-lg px-4 py-3">Designed for early years: playful, structured, and scalable</div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-green-900/40 to-blue-900/40 border border-green-500/30 rounded-2xl p-6 md:p-8 flex flex-col justify-between">
                <div>
                  <p className="text-sm uppercase tracking-widest text-green-300 mb-2">Hero Showcase</p>
                  <h3 className="text-3xl font-bold text-white mb-3">Learn to speak. Speak to learn.</h3>
                  <p className="text-gray-200">
                    Explore UKTI's interactive learning experience built for classrooms with voice, camera, and AI-powered activity modules.
                  </p>
                </div>
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    ...
                    className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-xl text-base font-semibold shadow-lg shadow-green-500/25 hover:shadow-green-500/40 transition-all duration-300"
                  >
                    Open UKTI Website
                  </a>
                  <button
                    onClick={() => window.open("https://meetukti.com/", "_blank", "noopener,noreferrer")}
                    className="inline-flex items-center px-6 py-3 border border-gray-500 text-gray-100 rounded-xl text-base font-semibold hover:bg-gray-800/60 transition-all duration-300"
                  >
                    View Hero Section
                  </button>
                </div>
